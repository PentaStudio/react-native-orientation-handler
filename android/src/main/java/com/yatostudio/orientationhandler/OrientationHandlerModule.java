package com.yatostudio.orientationhandler;
...
public class OrientationHandlerModule extends ReactContextBaseJavaModule implements LifecycleEventListener{
    final BroadcastReceiver receiver;

    public OrientationHandlerModule(ReactApplicationContext reactContext) {
        super(reactContext);
